...
interface ProductData {
  ...
  sustainability?: {
    ...
    energyRating?: string; // Use energyRating consistently
    ...
    if (productId === "prod_mfg_001" || productId.includes("EcoSmart Refrigerator")) {
      ...
      return {
        ...
        sustainability: {
          ...
          energyRating: "A+++", // Aligned to energyRating
          recyclability: "75%",
...
const PublicProductDisplayPageContent = () => {
  ...
  const getScoreColor = (rating: ProductData['sustainability']['sustainabilityScore']['rating'] | undefined) => {
    ...
    <div className="product-passport-display container mx-auto py-6 md:py-8 px-4 space-y-6 font-inter">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {product.sustainability?.sustainabilityScore && (
          <DetailCard title="Overall Sustainability Score" icon={Award} iconColor={getScoreColor(product.sustainability.sustainabilityScore.rating)} dataPresent={!!product.sustainability.sustainabilityScore} id="sustainability-score">
